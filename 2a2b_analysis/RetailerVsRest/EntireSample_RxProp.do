...
outreg2 using "F:\2a2b_analysis\RegisteredSalesAnalysis\diffINdiff_RxProp_TotalCount5_EntireSample",  tex replace nocons keep(Post iPostTreat) 

local TaxQuarterDummy "iTaxQuarter2 iTaxQuarter3 iTaxQuarter4 iTaxQuarter5 iTaxQuarter6 iTaxQuarter7 iTaxQuarter8 iTaxQuarter10 iTaxQuarter11 iTaxQuarter12 iTaxQuarter13 iTaxQuarter14 iTaxQuarter15 iTaxQuarter16 iTaxQuarter17 iTaxQuarter18 iTaxQuarter19 iTaxQuarter20"
areg MoneyDeposited Post iPostTreat `TaxQuarterDummy', cluster(DealerTIN) absorb(DealerTIN)
outreg2 using "F:\2a2b_analysis\RegisteredSalesAnalysis\diffINdiff_RxProp_TotalCount5_EntireSample",  tex append nocons keep(Post iPostTreat) 
...
coefplot (matrix(C), ci((2 3))), drop(_cons `TaxQuarterDummy') vertical yline(0) xline(8.5)
         ...
         note( "Number of firms is 63437.""Treatment is a continous variable, proportion of sales made to registered firms in the quarter in which the policy was introduced");
graph save Graph "F:\2a2b_analysis\RegisteredSalesAnalysis\PositiveContribution_EntireSample.gph";
graph export "F:\2a2b_analysis\RegisteredSalesAnalysis\PositiveContribution_EntireSample.pdf", as(pdf) replace;
...
coefplot (matrix(C), ci((2 3))), drop(_cons `TaxQuarterDummy') vertical yline(0) xline(8.5)
         ...
         note( "Number of firms is 63437.""Treatment is a continous variable, proportion of sales made to registered firms in the quarter in which the policy was introduced");
graph save Graph "F:\2a2b_analysis\RegisteredSalesAnalysis\VATDeposited_EntireSample.gph";
graph export "F:\2a2b_analysis\RegisteredSalesAnalysis\VATDeposited_EntireSample.pdf", as(pdf) replace;
...
coefplot (matrix(C), ci((2 3))), drop(_cons `TaxQuarterDummy') vertical yline(0) xline(8.5)
         ...
         note( "Number of firms is 63437.""Treatment is a continous variable, proportion of sales made to registered firms in the quarter in which the policy was introduced");
graph save Graph "F:\2a2b_analysis\RegisteredSalesAnalysis\TaxCreditBeforeAdjustment_EntireSample.gph";
graph export "F:\2a2b_analysis\RegisteredSalesAnalysis\TaxCreditBeforeAdjustment_EntireSample.pdf", as(pdf) replace;
...
coefplot (matrix(C), ci((2 3))), drop(_cons `TaxQuarterDummy') vertical yline(0) xline(8.5)
         ...
         note( "Number of firms is 63437.""Treatment is a continous variable, proportion of sales made to registered firms in the quarter in which the policy was introduced");
graph save Graph "F:\2a2b_analysis\RegisteredSalesAnalysis\OutputTaxBeforeAdjustment_EntireSample.gph";
graph export "F:\2a2b_analysis\RegisteredSalesAnalysis\OutputTaxBeforeAdjustment_EntireSample.pdf", as(pdf) replace;
...
title("Coefficient for OutputTax-InputCredit ")
         note( "Number of firms is 63437.""Treatment is a continous variable, proportion of sales made to registered firms in the quarter in which the policy was introduced");
graph save Graph "F:\2a2b_analysis\RegisteredSalesAnalysis\Diff_EntireSample.gph";
graph export "F:\2a2b_analysis\RegisteredSalesAnalysis\Diff_EntireSample.pdf", as(pdf) replace;
