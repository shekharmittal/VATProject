...
merge 1:1 DealerTIN TaxQuarter using "F:\2a2b_analysis\IntraFirmAnalysis\quarterly_dealers_all_sales.dta", keepusing(TransActionCount SumAmount SumTaxAmount SumTotalAmount)
