/*In this file we do the heterogeneity analysis in real terms*/
...
areg RealMoneyDeposited Post iPostTreat iTaxYear2 iTaxYear4 iTaxYear5 if TotalCount==5, cluster(DealerTIN) absorb(DealerTIN)
estimates store Decile1MoneyDeposited
areg RealTaxCreditBeforeAdjustment Post iPostTreat iTaxYear2 iTaxYear4 iTaxYear5 if TotalCount==5, cluster(DealerTIN) absorb(DealerTIN)
estimates store Decile1TaxCredit
areg RealOutputTaxBeforeAdjustment  Post iPostTreat iTaxYear2 iTaxYear4 iTaxYear5 if TotalCount==5, cluster(DealerTIN) absorb(DealerTIN)
