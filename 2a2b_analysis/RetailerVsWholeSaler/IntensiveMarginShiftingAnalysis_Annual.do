/*
In this analysis we will look at the intensive margins at which firms shift to evade taxes
*/
...
replace TotalPurchases=TotalPurchases/1000000
...
gen PurchaseGoodsAt1TurnoverRatio=PurchaseGoodsAt1/TurnoverGross
gen PurchaseGoodsAt125TurnoverRatio=PurchaseGoodsAt125/TurnoverGross
gen PurchaseGoodsAt20TurnoverRatio=PurchaseGoodsAt20/TurnoverGross
gen PurchaseGoodsAt5TurnoverRatio=PurchaseGoodsAt5/TurnoverGross

gen PurchaseGoodsAt1PurchaseRatio=PurchaseGoodsAt1/TotalPurchases
gen PurchaseGoodsAt125PurchaseRatio=PurchaseGoodsAt125/TotalPurchases
gen PurchaseGoodsAt20PurchaseRatio=PurchaseGoodsAt20/TotalPurchases
gen PurchaseGoodsAt5PurchaseRatio=PurchaseGoodsAt5/TotalPurchases
...
preserve;
keep if TotalCount==5;
collapse (sum) TurnoverAt125Ratio (mean) AvgMoneyDeposited=TurnoverAt125Ratio (semean) SEMoneyDeposited=TurnoverAt125Ratio, by(TaxYear Treat);
...
twoway (connected AvgMoneyDeposited TaxYear if Treat==0) 
	   ...
	   (line LHS TaxYear if Treat==1, lpattern(dot) lcolor(red)) (line RHS TaxYear if Treat==1, lpattern(dot) lcolor(red)), 
	   xline(2.5) 
...
# delimit;
areg  PurchaseGoodsAt125Ratio iTaxYear2 iTaxYear3 iTaxYear4 iTaxYear5 iTreat1 iTreat3  iTreat4 iTreat5, absorb(DealerTIN) cluster(DealerTIN);
forvalues i = 1(1)5 {;
	if(`i'!=2){;
...
coefplot (matrix(C), ci((2 3))), drop(_cons Post iTaxYear2 iTaxYear4 iTaxYear5) vertical yline(0) xline(2.5)
	     ...
	     title("Coefficient for Turnover at 12.5%") 
